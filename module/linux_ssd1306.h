#ifndef LINUX_SSD1306_H_
#define LINUX_SSD1306_H_
...
/* This structure will represent a single OLED device */
struct ssd1306_dev {
	struct i2c_client * client;
	struct miscdevice ssd1306_miscdevice;
    SSD1306_t oled_dev;
	char name[8]; /* ssd1306XX */
};
